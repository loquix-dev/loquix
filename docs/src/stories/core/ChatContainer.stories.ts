...
export const Full: Story = {
  ...
  render: args => html` <div style="width:700px;height:500px">
...
export const Panel: Story = {
  ...
  render: args => html` <div style="width:380px;height:600px">
...
export const Floating: Story = {
  ...
  render: args => html` <div style="width:360px;height:480px">
    <loquix-chat-container layout=${args.layout} mode=${args.mode}>
