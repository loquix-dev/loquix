...
export const WithAvatar: Story = {
  render: () => html` <div style="width:600px;display:flex;flex-direction:column;gap:8px">
...
export const AttachmentPositions: Story = {
  render: () => html` <div style="width:600px;display:flex;flex-direction:column;gap:16px">
